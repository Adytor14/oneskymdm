  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="max-w-[1400px]">
        ...
        <p className="text-muted-foreground mt-1">Analyze physician market data and trends</p>
      </div>
        ...
        {hcpMetrics.map((metric, index) => (
          <Card key={index} className={metric.bgColor}>
            <CardHeader className="pb-2">
              <CardTitle className="text-xl font-bold text-blue-600">{metric.value}</CardTitle>
                    ...
                    <tr className="border-b">
                      <th className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap">
                        <Checkbox
                          checked={
                            selectedRows.size > 0 &&
                            selectedRows.size === mockHCPs.filter((r) => r.status === "Active").length
                          }
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("annualPatientCount")}
                      >
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("l4qtrPatientCount")}
                      >
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("medicalDirector")}
                      >
                        Medical Director
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("referralAgency1")}
                      >
                        L4QTR Top Referring Agency
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("patientCount1")}
                      >
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("percentTotal1")}
                      >
                        % of Total Patients_1
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("referralAgency2")}
                      >
                        L4QTR Second Highest Referring Agency
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("patientCount2")}
                      >
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("percentTotal2")}
                      >
                        % of Total Patients_2
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("referralAgency3")}
                      >
                        L4QTR Third Referring Agency
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("patientCount3")}
                      >
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("percentTotal3")}
                      >
                        % of Total Patients_3
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("referralAgency4")}
                      >
                        L4QTR Forth Highest Referring Agency
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("patientCount4")}
                      >
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("percentTotal4")}
                      >
                        % of Total Patients_4
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("referralAgency5")}
                      >
                        L4QTR Fifth Referring Agency
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("patientCount5")}
                      >
                      ...
                      <th
                        className="text-left py-3 px-4 font-medium text-sm text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-accent/50"
                        onClick={() => handleSort("percentTotal5")}
                      >
                        % of Total Patients_5
                  ...
                  <tbody>
                    {(() => {
                      ...
                      const preparedData = activeRecords.map((record, index) => ({
                        ...
                        l4qtrPatientCount: Math.floor(Math.random() * 500) + 100,
                        growth: Math.floor(Math.random() * 20) + 1,
                        medicalDirector: [" Smith", " Johnson", "Dr. Williams", "Dr. Brown", "Dr. Davis"][index % 5],
                        mdAgency: [
                          "Skyra Medical",
                          "OneSky Home Health",
                          "JetHealth Agency",
                      ...
                      return paginatedData.map((record, index) => (
                        <tr key={index} className="border-b hover:bg-muted/50">
                          ...
                          <td className="py-3 px-4 whitespace-nowrap">
                            <Link to={`/hcp/${record.id}`} className="text-primary hover:underline font-medium">
                              {record.name}
                            </Link>
                          </td>
