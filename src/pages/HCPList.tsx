  ...
  const metrics = [
    {
      ...
      value: mockHCPs.length.toString(),
      icon: Users,
      bgColor: "bg-blue-50",
    ...
    },
    {
      ...
      value: totalDistinctPatients.toLocaleString(),
      icon: TrendingUp,
      bgColor: "bg-green-50",
          ...
          <CardContent>
            ...
            {(() => {
              ...
              const filteredData = activeRecords.filter((record) => {
                ...
                return (
                  name.includes(search) || npi.includes(search) || record.speciality[0].toLowerCase().includes(search)
                );
              });
